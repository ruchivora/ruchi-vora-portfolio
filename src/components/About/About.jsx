    ...
    <section id="about" className={styles.about}>
      ...
      <div className={styles.aboutContent}>
        <div className={styles.aboutText}>
          ...
          <p>Beyond coding, I love sharing my knowledge through writing. With  <strong>over 400 subscribers on Medium</strong>, I write about tech, helping others in their learning journey.</p>
          <SocialLinks />
        </div>
